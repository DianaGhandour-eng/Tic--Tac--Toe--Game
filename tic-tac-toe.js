...
function end(num1, num2, num3) {
  title.innerHTML = `${squares[num1]}Winner&#128512`;
  document.getElementById('item' +num1).style.background = "#F6FA70";
  document.getElementById('item' + num2).style.background = "#F6FA70";
  document.getElementById('item' + num3).style.background = "#F6FA70";
